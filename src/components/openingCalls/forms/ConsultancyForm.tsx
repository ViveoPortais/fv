...
const ConsultancyForm = ({ optionId, bgColor }: FormProps) => {
    const { register, handleSubmit, getValues, setValue, control, formState: { errors, isValid }, reset } = useForm<SchemaProps>({
    ...
    const createData = (form: SchemaProps) => {
        const data: IPostIncident = {
            ...
            availabilityStart: form.appointmentDate && form.appointmentStartTime ? `${form.appointmentDate}T${form.appointmentStartTime}:00` : null,
            availabilityEnd: form.appointmentDate && form.appointmentEndTime ? `${form.appointmentDate}T${form.appointmentEndTime}:00` : null,
            availabilityStart2: form.appointmentDate2 && form.appointmentStartTime2 ? `${form.appointmentDate2}T${form.appointmentStartTime2}:00` : null,
            availabilityEnd2: form.appointmentDate2 && form.appointmentEndTime2 ? `${form.appointmentDate2}T${form.appointmentEndTime2}:00` : null,
            availabilityStart3: form.appointmentDate3 && form.appointmentStartTime3 ? `${form.appointmentDate3}T${form.appointmentStartTime3}:00` : null,
            availabilityEnd3: form.appointmentDate3 && form.appointmentEndTime3 ? `${form.appointmentDate3}T${form.appointmentEndTime3}:00` : null,
        };
        return data;
    };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentStartTime && <span className="text-red-500 text-sm">{errors.appointmentStartTime.message}</span>}
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentEndTime && <span className="text-red-500 text-sm">{errors.appointmentEndTime.message}</span>}
                </div>

                <div className="flex flex-col">
                    <Input
                        type="date"
                        {...register("appointmentDate2")}
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentStartTime2 && <span className="text-red-500 text-sm">{errors.appointmentStartTime2.message}</span>}
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentEndTime2 && <span className="text-red-500 text-sm">{errors.appointmentEndTime2.message}</span>}
                </div>

                <div className="flex flex-col">
                    <Input
                        type="date"
                        {...register("appointmentDate3")}
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentStartTime3 && <span className="text-red-500 text-sm">{errors.appointmentStartTime3.message}</span>}
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    />
                    {errors.appointmentEndTime3 && <span className="text-red-500 text-sm">{errors.appointmentEndTime3.message}</span>}
                </div>
            </div>
